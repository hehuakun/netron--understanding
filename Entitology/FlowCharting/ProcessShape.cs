...
namespace Netron.GraphLib.Entitology
{
	...
	[Serializable]
	[Description("Process shape")]
	[NetronGraphShape("Process","68256A86-B456-4555-B6C4-33EE0B87CE71","FlowCharting","Netron.GraphLib.Entitology.ProcessShape",
		 "A process shape.")]
	public class ProcessShape : EllipseShape, ISerializable
	{		
		#region Constructors
		/// <summary>
		/// Constructor
		/// </summary>
		public ProcessShape() : base(){	}
		/// <summary>
		/// This is the default constructor of the class.
		/// </summary>
		public ProcessShape(IGraphSite site) : base(site){}
		/// <summary>
		/// Deserialization constructor
		/// </summary>
		/// <param name="info"></param>
		/// <param name="context"></param>
		protected ProcessShape(SerializationInfo info, StreamingContext context) : base(info, context){	}
		#endregion	
