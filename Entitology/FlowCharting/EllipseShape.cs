...
namespace Netron.GraphLib.Entitology
{
	...
	[NetronGraphShape("Ellipse","9017DAD1-A8CF-465d-AD1C-8EDF53BFCB52","FlowCharting","Netron.GraphLib.Entitology.EllipseShape",
		 "An elliptic shape.")]
	public class EllipseShape : Shape, ISerializable
	{
		#region Fields
		...
		/// </summary>
		public EllipseShape(IGraphSite site) : base(site)
		{
		...
		public override Bitmap GetThumbnail()
		{
			...
			try
			{
				Stream stream=Assembly.GetExecutingAssembly().GetManifestResourceStream("Netron.GraphLib.BasicShapes.Resources.EllipseShape.gif");
			...
			{
				Trace.WriteLine(exc.Message,"EllipseShape.GetThumbnail");
			}
			return bmp;
		}
		...
		public override void Paint(Graphics g)
		{
			...
			if(this.ShapeColor!=Color.Transparent)
				g.FillEllipse(this.BackgroundBrush,Rectangle);
			g.DrawEllipse(this.BlackPen, Rectangle);
