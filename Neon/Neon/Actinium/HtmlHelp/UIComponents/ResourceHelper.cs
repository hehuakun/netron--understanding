...
namespace Netron.Neon.HtmlHelp.UIComponents
{
	/// <summary>
	...
	public sealed class ResourceHelper
	{
		...
		public ResourceHelper() : this("Netron.Neon.Actinium.HtmlHelp", null)
		{
		}
		/// <summary>
		/// Constructs a new resource helper class.
		...
		public ResourceHelper(Assembly resAssembly) : this("Netron.Neon.Actinium.HtmlHelp", resAssembly)
		{
		}
		/// <summary>
		/// Constructs a new resource helper class.
