...
namespace Netron.Neon.HtmlHelp
{
	/// <summary>
	...
	public class TableOfContents
	{
		...
		internal void MergeToC( ArrayList arrToC )
		{
			...
			Trace.WriteLine("TableOfContents.MergeToC() ");
			Trace.Indent();
			Trace.WriteLine("Start: " + DateTime.Now.ToString("HH:mm:ss.ffffff"));
			MergeToC(_toc, arrToC, null);
			Trace.WriteLine("End: " + DateTime.Now.ToString("HH:mm:ss.ffffff"));
			Trace.Unindent();
		}
