...
namespace Netron.Neon
{
	internal class ResourceHelper
	{
		...
		{
			m_resourceManager = new ResourceManager("Netron.Neon.Actinium.Docking.Strings", typeof(DockPanel).Assembly);
		}
	
		public static Bitmap LoadBitmap(string name)
		{
			Assembly assembly = typeof(ResourceHelper).Assembly;
			string fullNamePrefix = "Netron.Neon.Actinium.Docking.Resources.";
