...
using Netron.Neon.TextEditor.Util;
...
//			((DefaultWorkbench)WorkbenchSingleton.Workbench).UpdateToolbars();
		...
		{
			new Netron.Neon.TextEditor.Actions.Delete().Execute(textArea);
		}
		
		public void SelectAll(object sender, EventArgs e)
		{
			new Netron.Neon.TextEditor.Actions.SelectWholeDocument().Execute(textArea);
		}
