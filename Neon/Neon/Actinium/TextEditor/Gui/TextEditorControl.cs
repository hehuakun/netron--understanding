...
namespace Netron.Neon.TextEditor
{
	/// <summary>
	/// This class is used for a basic text area control
	/// </summary>
//	[ToolboxBitmap("Netron.Neon.TextEditor.TextEditorControl.bmp")]
	[ToolboxItem(true)]
	public class TextEditorControl : TextEditorControlBase, INUITextEditor
	{
		...
		public event System.EventHandler OnShow;
		...
		{
			Document.HighlightingStrategy = HighlightingStrategyFactory.DefaultHighlightingStrategy;
		}
