...
namespace Netron.Neon {
	...
	/// </remarks>
	public class NRichTextBox : System.Windows.Forms.RichTextBox {
		...
		public NRichTextBox(RtfColor _textColor) : this() {
		...
		public NRichTextBox(RtfColor _textColor, RtfColor _highlightColor) : this() {
			textColor = _textColor;
