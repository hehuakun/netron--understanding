...
namespace  Netron.Neon
{
	...
	/// </summary>
	public class NOutput : UserControl, INOutput
	{
		public event StringNotification OnNewOutputMessage;
		public event StringNotification OnChannelRemoved;
		public event StringNotification OnChannelAdded;
		...
		public OutputChannelCollection Channels
		{
			get{return channels;}			
		}
		...
		public void AddChannel(string channelName)
		{
			if(channels[channelName]==null)
			{
				...
				channel.OnNewOutput+=new ChannelNotification(channel_OnNewOutput);
				channel.OnClear+=new StringNotification(channel_OnClear);
		...
		private void channel_OnNewOutput(string channel, string msg)
		{
			if(current == channel)
			{
				this.OutputText.Text += Environment.NewLine + msg;
				this.OutputText.SelectionStart=this.OutputText.Text.Length;
				this.OutputText.ScrollToCaret();
				if(this.OnNewOutputMessage!=null)
					OnNewOutputMessage(msg);
			}
		}
		...
		private void channel_OnClear(string name)
		{
